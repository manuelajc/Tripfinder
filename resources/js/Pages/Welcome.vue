...
<template>
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-cover bg-dots-darker wenas">
        <div class="minav">
            ...
            <div>
                <div class="text-center text-3xl text-gray-500 dark:text-white sm:text-end sm:ms-0">
                    ¡Bienvenido a TripFinder!
            </div>
            <div class="text-center text-sm text-gray-500 dark:text-white sm:ms-0">
                Viaja en una ciudad que florece
            </div>
    </div>
            </div>
        </div>
